...
public class ThesaurusEditTextActivity extends AppCompatActivity{
        ...
        recyclerView.addOnItemTouchListener(new RecyclerThesaurusItemListner(getApplicationContext(), recyclerView, new RecyclerThesaurusItemListner.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (isFromCreateAppointment){
                    Intent intent = new Intent(ThesaurusEditTextActivity.this, CreateAppointmentActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.putExtra("synonymWordSelectedFromThesaurusEditText", removeDelimeterSynonym);
                    ...
                    Intent intent = new Intent(ThesaurusEditTextActivity.this, EditItemActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.putExtra("synonymWordSelectedFromThesaurusEditText", removeDelimeterSynonym);
